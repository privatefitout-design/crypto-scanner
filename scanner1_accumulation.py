...
def pattern_d(symbol, k1d, k1h, oi_d, oi_1h):
    ...
    for bw in [6, 10, 14, 20, 30, 45, 60, 90, 120, 180]:
        ...
        if br < best_base_range and br <= BASE_RANGE_MAX:
            best_base_range  = br
            best_base_window = bw
    ...
    # Бонус за длину накопления
    if base_window >= 60:   score += 10
    elif base_window >= 30: score += 6
    elif base_window >= 14: score += 3
